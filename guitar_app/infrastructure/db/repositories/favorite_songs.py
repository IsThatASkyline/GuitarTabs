...
from guitar_app.application.guitar.dto import FavoriteSongDTO, SongDTO
...
class FavoriteRepository(BaseRepository[UserFavorite]):
    ...
    async def add_favorite_song(self, fav_dto: FavoriteSongDTO) -> None:
