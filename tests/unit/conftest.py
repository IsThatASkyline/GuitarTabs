...
async def modulation_in_data():
    return [BaseVerseDTO(title='verse1', lyrics='lyrics', chords='Am C Dm G'),
            BaseVerseDTO(title='verse2', lyrics='lyrics', chords='A Cm D Gm')], 1
...
async def modulation_in_data2():
    return [BaseVerseDTO(title='verse1', lyrics='lyrics', chords='Am C Dm G'),
            BaseVerseDTO(title='verse2', lyrics='lyrics', chords='A Cm D Gm')], -2
