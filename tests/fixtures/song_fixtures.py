...
from guitar_app.infrastructure.db.models import Song, UserFavorite, Verse


@pytest_asyncio.fixture(scope="function")
async def create_song_in_database(db_session_test: sessionmaker):
    async def create_song_in_database_wrap(song_id: int, title: str, band_id: int, verses):
...
async def song_data():
    return {
        ...
        "band_id": 1,
        "verses": [
            {"title": "verse1", "lyrics": "lyrics", "chords": "Am C Dm G"},
            {"title": "verse2", "lyrics": "lyrics", "chords": "A Cm D Gm"},
        ],
    }
...
async def after_modulate_song_data1():
    return {
        ...
        "verses": [
            {"title": "verse1", "lyrics": "lyrics", "chords": "A#m C# D#m G#"},
...
async def after_modulate_song_data2():
    return {
        ...
        "verses": [
            {"title": "verse1", "lyrics": "lyrics", "chords": "Gm A# Cm F"},
