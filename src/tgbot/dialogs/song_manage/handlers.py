...
from src.application.guitarapp import dto, services
from src.application.guitarapp.exceptions import SongNotExists
...
async def select_song_founded_by_title(c: CallbackQuery, widget: Any, manager: DialogManager, item_id: str):
    await c.answer()
    data = manager.dialog_data
    if not isinstance(data, dict):
        data = {}
